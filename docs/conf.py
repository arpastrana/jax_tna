...
def linkcode_resolve(domain, info):
    ...
    if not package.startswith('jax_tna'):
        return None
    ...
    return f"https://github.com//jax_tna/blob/master/src/{filename}.py#L{lineno}"
...
html_theme_options = {
    "package_name"    : "jax_tna",
    "package_title"   : project,
    "package_version" : release,
    "package_author"  : "Rafael Pastrana",
    "package_docs"    : "https://.github.io/jax_tna/",
    "package_repo"    : "https://github.com//jax_tna",
    "package_old_versions_txt": "https://.github.io/jax_tna/doc_versions.txt"
}
